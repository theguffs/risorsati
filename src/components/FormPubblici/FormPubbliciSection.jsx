...
import './FormPubbliciSection.css'

export const FormPubbliciSection = () => {
  ...
  if (loading) {
    return <div className="form-pubblici-loading">Caricamento...</div>
  }

  return (
    <div className="form-pubblici-section">
      <div className="form-pubblici-header">
        <h2>Form Pubblici</h2>
      ...
      <div className="form-pubblici-actions">
